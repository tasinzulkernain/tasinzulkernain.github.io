...
* **Microcontrollers:** Arduino Mega (Dual architecture integration), Raspberry Pi
* **Flight Controllers:** APM 2.8, Mission Planner, ArduPilot
* **Actuators & Sensors:** BLDC Motors (DJI 2212), Servo Motors (MG995), MPU6050 Gyroscopes, ADXL345 Accelerometers
* **Theory:** Glauert’s Theory (Coaxial Propulsion), PID Tuning, Motion Prediction

**Software & Development**
* **Languages:** C/C++ (Embedded), Python (Automation), PowerShell/C#, Bash
* **Infrastructure:** Linux (Ubuntu/Debian) CLI, Docker, Nginx Proxy Manager, Proxmox (Hypervisor), UnRAID
...
**Creative Production**
* **Video/Photo:** DaVinci Resolve, Adobe Premiere Pro, Illustrator, Photoshop
* **Gear:** Sony FX6, Sony A7S3, FPV Drones, DJI Ecosystem, 4K Multicam Broadcasting
...
*Quadcopter Flying and Walking Mechanism using Same Limbs.*
* **Innovation:** Engineered an X8 Coaxial Quadcopter capable of transforming flight wings into 3-DOF walking legs for hazardous environments.
* **Tech:** Integrated 16 MG995 servos and 8 BLDC motors to solve energy inefficiency in hovering drones.
...
* **Content Strategist @ Build with Shah** (2020): Developed YouTube content strategy, directed video shoots, and managed social media.
* **Co-Founder @ Positive Bangladesh** (2018–2020): Developed the business model for a PVE/CVE social startup.
* **Head of Documentation @ Think Twice Act Wise** (2017–2019): Managed photography, video production, and activity archiving.

---

### 🤝 Leadership & Volunteering

* **Vilnius University Ambassador** (2025–Present): Selected to mentor prospective international students, providing guidance on integrating into the EU DeepTech ecosystem.
* **Under Secretary General @ DUNMUN** (2019): Managed documentation teams for the Dhaka United National Model United Nations.
* **Director of Documentation @ DUNMUN** (2018).
* **Cultural Secretary @ Robotics & Mechatronics Engineering Student Club** (2018-2019).
...
* 🥇 **President's Scouts Award (2013):** Highest rank in Bangladesh Scouts.
* 🥇 **Winner, P2P Facebook Global Digital Challenge (2019):** Brussels, Belgium.
* 🥇 **Winner, P2P Facebook Global Digital Challenge (2017):** USA.
* 🥈 **1st Runner Up, UNDP Digital Khichuri Challenge (2019):** Solutions for fake news prevention.
...
*"If you build it, they won't come unless you build the road too." — Analysis on Infrastructure Voids from my Master's Thesis*
